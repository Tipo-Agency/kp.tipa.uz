        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <BodyText className="mb-12">
              Мы создаем полноценную экосистему, предназначенную для перевода вашего бренда от «случайного постинга» к «системному присутствию на рынке». Каждый элемент взаимосвязан.
            </BodyText>
