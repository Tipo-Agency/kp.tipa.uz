...
const Module: React.FC<{ title: string; items: string[]; Icon: React.FC }> = ({ title, items, Icon }) => (
  <div className="p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-md hover:border-[#3337AD]/20 transition-all w-full">
    <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-[#3337AD]/10 flex items-center justify-center mb-4">
      <Icon />
    </div>
    <h3 className="text-base sm:text-lg font-bold text-[#3337AD] mb-3 sm:mb-4">{title}</h3>
