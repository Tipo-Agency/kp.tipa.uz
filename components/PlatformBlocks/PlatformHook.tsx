...
export const PlatformHook: React.FC<PlatformHookProps> = ({
  clientName,
  title,
  subtitle,
  arguments: args = [],
  ...
  <section className="min-h-[85vh] sm:min-h-[90vh] flex items-center pt-16 sm:pt-20 pb-10 sm:pb-12 relative bg-slate-50 overflow-hidden">
    <div
      ...
      style={{ backgroundColor: `${ACCENT}15`, clipPath: "polygon(20% 0, 100% 0, 100% 100%, 0% 100%)" }}
    />
    <Container className="relative z-10">
      <div className="mb-8 sm:mb-12">
        ...
        />
        <p className="font-bold tracking-widest uppercase mb-3 sm:mb-4 text-xs sm:text-sm" style={{ color: ACCENT }}>
          Разработка сервиса под ключ
        </p>
          ...
          <ul className="space-y-2 sm:space-y-3">
            {args.map((arg, i) => (
              <li key={i} className="flex items-start sm:items-center gap-3">
                <span
                  className="w-2 h-2 rounded-full flex-shrink-0 mt-2 sm:mt-1.5"
