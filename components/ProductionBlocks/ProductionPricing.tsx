...
export const ProductionPricing: React.FC<Props> = ({
  amount,
  currency,
  period,
  deliverables,
      ...
      <Container>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            <p className="text-[#8B5CF6] font-bold tracking-[0.3em] uppercase mb-6 text-[10px]">
              Commercial Terms
            </p>
          ...
          <div className="bg-[#0A0C14] rounded-[3rem] p-12 md:p-16 text-white shadow-2xl relative overflow-hidden">
            <div className="relative z-10">
              <h3 className="text-xs font-bold text-[#8B5CF6] uppercase tracking-widest mb-12">
                Объём работ / {period}
              </h3>
                ...
                <>
                  ...
                  <div className="text-center">
                    <a
                      ...
                      className="inline-block bg-[#8B5CF6] hover:bg-[#7C3AED] text-white px-10 py-5 rounded-2xl font-bold text-lg transition-all shadow-xl shadow-violet-500/20 active:scale-95"
                    >
                      Принять предложение
                    </a>
                  </div>
                ...
                <>
                  ...
                  <div className="flex flex-col lg:flex-row justify-between items-center gap-6 pt-8 mt-4 border-t border-white/5">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full lg:w-auto bg-[#8B5CF6] hover:bg-[#7C3AED] text-white px-10 py-5 rounded-2xl font-bold text-lg transition-all shadow-xl shadow-violet-500/20 active:scale-95 text-center"
                    >
                      Принять предложение
                    </a>
                  </div>
            ...
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#8B5CF6] opacity-10 blur-[100px] pointer-events-none" />
          </div>
