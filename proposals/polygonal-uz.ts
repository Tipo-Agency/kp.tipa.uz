...
export const polygonalUz: ProposalData = {
  ...
  hero: {
    ...
    subtitle:
      "Продвижение https://www.instagram.com/polygonal.uz/ — контент под ваш продукт или услугу: стратегия, визуал, Reels, таргет и аналитика. Детали позиционирования уточняем на брифинге под актуальное направление бизнеса.",
  },
  services: [
    {
      title: "Стратегия",
